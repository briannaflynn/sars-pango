...
clist = ["#fcba03", "#4bd927", "#fa887f", "#00f2ff", "#147399", "#36AEFF", "#005eff", "#5d00ff", "#8800ff", "#ea00ff",
         "#90e0c1", "#fcab74", "#000099", "#8a6d77", "#6d768a", "#1f9c85", "#7583d1", "#ff0004"]
...
def get_figure(tree, emap, pth="./", name="tree-plot", type="png", height=1400, width=1000, tip_labels=False,
    ...
    canvas, _, _ = tree.draw(height=height, width=width, tip_labels=tip_labels, tip_labels_align=tip_labels_align,
                             tip_labels_style=tip_labels_style, edge_colors=ecolors, edge_widths=ewidths)
    ...
    return tree.draw(height=height, width=width, tip_labels=tip_labels, tip_labels_align=tip_labels_align,
                     tip_labels_style=tip_labels_style, edge_colors=ecolors, edge_widths=ewidths)
